...
\item
  ...
  \begin{itemize}
	\resitem{Dissertation: Time-Dependent Radiation Transport using
...
\begin{enumerate}
  ...
  \item E. Asano, D. Coleman, G. Davidson, and S. Dewji, ``Photon Detector 
    Response Function Methodology using MCNP and Shift Hybrid Radiation 
    Transport Code for Wide-Area Contamination Assay Applications,'' Nuclear 
    Instruments and Methods in Physics Research Section A: Accelerators, 
    Spectrometers, Detectors and Associated Equipment, \textbf{1031}, 1, (2022),
    https://doi.org/10.1016/j.nima.2022.166568. 
...
\begin{enumerate}
  \item Mathew Swinney and Gregory Davidson, ``A Parametric Study of Criticality 
    in Dual-Purpose Canisters for Long-Term Disposal'', International High-Level 
    Radioactive Waste Management Conference, Phoenix, AZ, November 13-17, (2022) 
    (to appear). 
  \item Elliott Biondo, Gregory Davidson, and Brian Ade, ``Layered CSG/CAD   
    Geometry for Neutronics Modeling of Advanced Reactors,'' PHYSOR 2022, May 15 
    - 20 (2022).
  \item B.J. Ade, E. Biondo, D.P. Schappel, E. Fountain, B.R. Betzler, and G. 
    Davidson, ``Preliminary Assessment of As-Built Design Characteristics for 
    the Transformational Challenge Reactor,'' PHYSOR 2022, May 15 - 20 (2022).
  \item Benjamin R. Betzler, David Chandler, Thomas M. Evans, Gregory
...
\begin{enumerate}
  \item Matthew Bement, Greg Davidson, Marco Delchini, Taylor Erwin, Ryan 
    Glasby, John Langford, Stuart Slattery, Doug Stefanski, ``Oak Ridge National 
    Laboratory Interim Report on ASINA Model Development Tasks'', ORNL/SPR-2022/
    2546 (2022) (to appear).
  \item Sarma Gorti and Gregory Davidson, ``Evaluation of the Sierra Simulation  
    Package for ASINA Integrated Modeling'', ORNL/TM-2022/2497 (2022) (to 
    appear).
  ...
  \item J. Langford, J. Basinger, M. Bement, G. Davidson, ``ASINA Task
    4 Software Requirements Specification,'' ORNL/SPR-2021/1906.
  \item J. Langford, J. Basinger, G. Davidson, ``ASINA Task 4
    Technology Maturation Plan,'' ORNL/SPR-2021/1907.
...
\begin{enumerate}
  \item Mathew Swinney, Santosh Bhatt, Gregory Davidson, Michael Nole, and 
    Kaushik Banerjee, ``Steady-State Power Calculations with Coupled TH and 
    Neutronics'', Spent Fuel and Waste Disposition Annual Program Meeting, 
    virtual meeting, May 11-12 (2022). 
...
\begin{itemize}
  \item Member of the American Nuclear Society (ANS), 1998-Present
    \begin{itemize}
      \item Member M\&C 2021 Organizing Committee
    ...
    \end{itemize}
  \item Member of Society of Industrial and Applied Mathematics
    (SIAM), 2020-Present
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\resheading{Copyrights}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{itemize}
\item U.S. Copyright, UT-Battelle 90000069, VERA Infrastructure
\item U.S. Copyright, UT-Battelle 90000072, Exnihilo (Shift/Denovo)
\item U.S. Copyright, UT-Battelle 90000065, ORIGEN API
\end{itemize}
